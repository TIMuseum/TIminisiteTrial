...
var Water = function ( geometry, options ) {
	...
	var normalMap0 = options.normalMap0 || textureLoader.load( 'media/Water_1_M_Normal.jpg' );
	var normalMap1 = options.normalMap1 || textureLoader.load( 'media/Water_2_M_Normal.jpg' );
